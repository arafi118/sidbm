...
@section('content')
    <div class="nav-wrapper position-relative end-0">
        <ul class="nav nav-pills nav-fill p-1" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#ProfilLembaga" role="tab"
                    aria-controls="ProfilLembaga" aria-selected="false">
                    <span class="material-icons align-middle mb-1">
                        group
                    </span>
                    Profil Lembaga
        ...
        <div class="tab-content mt-2">
            ...
            <div class="tab-pane fade" id="ProfilLembaga" role="tabpanel" aria-labelledby="ProfilLembaga">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="my-2">
                                        ...
                                        <select class="form-control" name="kategori_pinjaman" id="kategori_pinjaman">
                                            @foreach ($fungsi_kelompok as $fk)
                                                <option {{ $lembaga_lain->fungsi_kelompok == $fk->id ? 'selected' : '' }}
                                                    value="{{ $fk->id }}">
                        ...
                        <button type="submit" id="SimpanLembaga" class="btn btn-github btn-sm float-end">Simpan
                            Lembaga</button>
                    </div>
                </div>
            </div>
