            ...
            <tr>
                <td colspan="3" align="center">
                    <div style="font-size: 18px;">
                        <b>
                            REKAP LUNAS {{ strtoupper($jpp->nama_jpp) }}
                        </b>
                    </div>
            ...
            <tbody>
                @foreach ($jpp->pinjaman_kelompok as $pinkel)
                    ...
                    @if (array_count_values($kd_desa)[$pinkel->kd_desa] <= '1')
                        @if ($section != $desa && count($kd_desa) > 1)
                            ...
                            <tr style="font-weight: bold;">
                                ...
                                <td class="t l b" align="right">{{ number_format($j_waiting, 2) }}</td>
                                <td class="t l b r" align="right">{{ number_format($j_waiting_lalu, 2) }}</td>
                            </tr>
                        @endif

                        <tr style="font-weight: bold;">
                            <td class="t l b r" colspan="9" align="left" height="15">
                    ...
                    <tr>
                        ...
                        <td class="t l b r" align="left" colspan="8">
                    ...
                    @foreach ($pinkel->pinjaman_anggota as $pinjaman_anggota)
                        ...
                        <tr>
                            ...
                            <td class="t l b" align="right">{{ number_format($pinjaman_verifikasi_lalu, 2) }}</td>
                            <td class="t l b" align="right">{{ number_format($pinjaman_anggota->alokasi, 2) }}</td>
                            <td class="t l b r" align="right">{{ number_format($pinjaman_waiting_lalu, 2) }}</td>
                        </tr>
                    @endforeach
                    ...
                    @php
                        ...
                        $waiting_kelompok = $waiting ?: $pinkel->waiting;
                        $waiting_lalu_kelompok = $waiting_lalu;
                        ...
                        $j_waiting += $waiting_kelompok;
                        $j_waiting_lalu += $waiting_lalu_kelompok;
                    @endphp
                    ...
                    <tr>
                        ...
                        <td class="t l b" align="right">
                            {{ number_format($waiting_kelompok, 2) }}
                        </td>
                        <td class="t l b r" align="right">
                            {{ number_format($waiting_lalu_kelompok, 2) }}
                        </td>
                    </tr>
                @endforeach
                    ...
                    <tr>
                        <td colspan="9" style="padding: 0px !important;">
                            <table class="p" border="0" width="100%" cellspacing="0" cellpadding="0"
                                ...
                                <tr style="background: rgb(230, 230, 230); font-weight: bold;">
                                    <td class="t l b" align="center" width="40%" height="15">
                                        J U M L A H
                                    </td>
                                    ...
                                    <td class="t l b" width="10%" align="right">
                                        {{ number_format($t_waiting) }}
                                    </td>
                                    <td class="t l b r" width="10%" align="right">
                                        {{ number_format($t_waiting_lalu) }}
                                    </td>
                                </tr>
