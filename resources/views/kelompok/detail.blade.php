...
<div class="nav-wrapper position-relative end-0">
    ...
    <div class="tab-content mt-2">
        ...
        <div class="tab-pane fade" id="ProfilKelompok" role="tabpanel" aria-labelledby="ProfilKelompok">
            <div class="card">
                <div class="card-body">
                    <form action="/database/kelompok/{{ $kelompok->kd_kelompok }}" method="post" id="FormEditKelompok">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-group-static my-3">
                                    ...
                                    <input autocomplete="off" type="text" name="alamat_kelompok" id="alamat_kelompok"
                                        class="form-control" value="{{ $kelompok->alamat_kelompok }}">
    ...
    <div class="card mt-3">
        <div class="card-body p-2">
            <a href="/database/kelompok" class="btn btn-info float-end mb-0">Kembali</a>
        </div>
    </div>
</div>
@endsection
