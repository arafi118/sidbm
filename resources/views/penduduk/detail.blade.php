...
<div class="nav-wrapper position-relative end-0">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="/database/penduduk/{{ $penduduk->nik }}" method="post" id="Penduduk">
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-group-static my-3">
                                    ...
                                    <input autocomplete="off" maxlength="16" type="text" name="nik" id="nik"
                                        class="form-control" value="{{ $penduduk->nik }}">
                                    ...
                                    <div class="col-7">
                                        <div class="input-group input-group-static my-3">
                                            ...
                                            <input autocomplete="off" type="text" name="tempat_lahir" id="tempat_lahir"
                                                class="form-control" value="{{ $penduduk->tempat_lahir }}">
                        ...
                        <button type="submit" class="btn btn-primary float-end" id="SimpanPenduduk">
                            Simpan Penduduk
                        </button>
                    </form>
                </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush mt-2">
                        ...
                        <li class="list-group-item">
                            ...
                            @endphp
                            <blockquote class="blockquote text-white mb-1 pointer">
    ...
    <div class="card mt-3">
        <div class="card-body p-2">
            <a href="/database/penduduk" class="btn btn-info float-end mb-0">Kembali</a>
        </div>
    </div>
</div>
@endsection
