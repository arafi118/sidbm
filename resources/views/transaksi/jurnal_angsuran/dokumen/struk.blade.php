...
<body onLoad="window.print()">
    <table width="100%" action="" border="0" align="center" cellpadding="1" cellspacing="1.5" class="style1">
        ...
        <tr>
            <th colspan="4" rowspan="3">DELAPAN BELAS JUTA LIMA RATUS DELAPAN PULUH DUA RIBU RUPIAH</th>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
