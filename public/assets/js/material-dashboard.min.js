...
var localConfig = document.querySelector('#localConfig')
if (localConfig) {
    localConfig = JSON.parse(localConfig.value)
}
...
function sidebarColor(e) {
    ...
    saveLocalConfig('sidebarColor', n)
}
...
function sidebarType(e) {
    ...
    // "bg-transparent" != a && "bg-white" != a || !i ? (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.png") && (c = o.replace("logo-ct-dark", "logo-ct"), r.src = c) : (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c), "bg-white" == a && n && (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c)

    saveLocalConfig("sidebarType", a)
}
...
function navbarFixed(e) {
    ...
    e.getAttribute("checked") ? (a.classList.remove(...t), a.setAttribute("data-scroll", "false"), navbarBlurOnScroll("navbarBlur"), e.removeAttribute("checked")) : (a.classList.add(...t), a.setAttribute("data-scroll", "true"), navbarBlurOnScroll("navbarBlur"), e.setAttribute("checked", "true"))

    saveLocalConfig('navbarFixed', e.getAttribute('checked') ? "position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky" : "")
}
...
function navbarMinimize(e) {
    ...
    saveLocalConfig('sidebarMini', e.getAttribute('checked') ? "g-sidenav-hidden" : "g-sidenav-pinned")
}
...
function initNavs() {
    total.forEach(function (l, e) {
        var s = document.createElement("div"),
            ...
            a = (t.innerHTML = "-", s.classList.add("moving-tab", "position-absolute", "nav-link"), s.appendChild(t), l.appendChild(s), l.getElementsByTagName("li").length, s.style.padding = "0px", s.style.transition = ".5s ease", l.querySelector(".nav-link.active").parentElement);
        if (a) {
            var n = Array.from(a.closest("ul").children),
                t = n.indexOf(a) + 1;
            let e = 0;
            if (l.classList.contains("flex-column")) {
                for (var i = 1; i <= n.indexOf(a); i++) e += l.querySelector("li:nth-child(" + i + ")").offsetHeight;
                s.style.transform = "translate3d(0px," + e + "px, 0px)", s.style.width = l.querySelector("li:nth-child(" + t + ")").offsetWidth + "px", s.style.height = l.querySelector("li:nth-child(" + i + ")").offsetHeight
            } else {
                for (i = 1; i <= n.indexOf(a); i++) e += l.querySelector("li:nth-child(" + i + ")").offsetWidth;
                s.style.transform = "translate3d(" + e + "px, 0px, 0px)", s.style.width = l.querySelector("li:nth-child(" + t + ")").offsetWidth + "px"
            }
        }
...
function toggleSidenav() {
    ...
    }, 100), sidenav.classList.remove("bg-transparent")) : (body.classList.add(className), sidenav.classList.remove("bg-transparent"), iconSidenav.classList.remove("d-none"))
}
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        saveLocalConfig('darkMode', "false")
        t.classList.remove("dark-version");
        for (w = 0; w < a.length; w++) a[w].classList.contains("light") && (a[w].classList.add("dark"), a[w].classList.remove("light"));
        for (w = 0; w < n.length; w++) n[w].classList.contains("light") && (n[w].classList.add("dark"), n[w].classList.remove("light"));
        for (w = 0; w < y.length; w++) y[w].classList.add("blur", "shadow-blur");
        for (w = 0; w < i.length; w++) i[w].classList.contains("text-white") && (i[w].classList.remove("text-white"), i[w].classList.add("text-dark"));
        for (w = 0; w < s.length; w++) !s[w].classList.contains("text-white") || s[w].closest(".sidenav") || s[w].closest(".card.bg-gradient-dark") || (s[w].classList.remove("text-white"), s[w].classList.add("text-dark"));
        for (w = 0; w < o.length; w++) o[w].classList.contains("text-white") && (o[w].classList.remove("text-white"), o[w].classList.add("text-dark"));
        for (w = 0; w < d.length; w++) d[w].classList.contains("text-white") && !d[w].closest(".sidenav") && (d[w].classList.remove("text-white"), d[w].classList.add("text-dark"));
        for (w = 0; w < u.length; w++) u[w].classList.contains("text-white") && (u[w].classList.remove("text-white"), u[w].classList.remove("opacity-8"), u[w].classList.add("text-dark"));
        for (w = 0; w < g.length; w++) g[w].classList.contains("bg-gray-600") && (g[w].classList.remove("bg-gray-600"), g[w].classList.add("bg-gray-100"));
        for (w = 0; w < b.length; w++) b[w].hasAttribute("fill") && b[w].setAttribute("fill", "#252f40");
        for (w = 0; w < h.length; w++) h[w].closest(".card.bg-gradient-dark") || (h[w].classList.remove("text-white"), h[w].classList.add("text-dark"));
        for (w = 0; w < p.length; w++) p[w].classList.remove("border-dark");
        e.removeAttribute("checked")
    } else {
        saveLocalConfig('darkMode', "dark-version")
        t.classList.add("dark-version");
        for (var w = 0; w < a.length; w++) a[w].classList.contains("dark") && (a[w].classList.remove("dark"), a[w].classList.add("light"));
        for (var w = 0; w < y.length; w++) y[w].classList.contains("blur") && y[w].classList.remove("blur", "shadow-blur");
        for (var w = 0; w < n.length; w++) n[w].classList.contains("dark") && (n[w].classList.remove("dark"), n[w].classList.add("light"));
        for (var w = 0; w < i.length; w++) i[w].classList.contains("text-dark") && (i[w].classList.remove("text-dark"), i[w].classList.add("text-white"));
        for (var w = 0; w < l.length; w++) l[w].classList.contains("text-dark") && (l[w].classList.remove("text-dark"), l[w].classList.add("text-white"));
        for (var w = 0; w < r.length; w++) r[w].classList.contains("text-dark") && (r[w].classList.remove("text-dark"), r[w].classList.add("text-white"));
        for (var w = 0; w < c.length; w++) c[w].classList.contains("text-dark") && (c[w].classList.remove("text-dark"), c[w].classList.add("text-white"));
        for (var w = 0; w < u.length; w++) u[w].classList.contains("text-secondary") && (u[w].classList.remove("text-secondary"), u[w].classList.add("text-white"), u[w].classList.add("opacity-8"));
        for (var w = 0; w < m.length; w++) m[w].classList.contains("bg-gray-100") && (m[w].classList.remove("bg-gray-100"), m[w].classList.add("bg-gray-600"));
        for (var w = 0; w < f.length; w++) f[w].classList.remove("text-dark"), f[w].classList.add("text-white");
        for (var w = 0; w < b.length; w++) b[w].hasAttribute("fill") && b[w].setAttribute("fill", "#fff");
        for (var w = 0; w < v.length; w++) v[w].classList.add("border-dark");
        e.setAttribute("checked", "true")
    }
}
window.addEventListener("resize", navbarColorOnResize), window.addEventListener("resize", sidenavTypeOnResize), window.addEventListener("load", sidenavTypeOnResize), window.onload = function () {
    for (var e = document.querySelectorAll("input"), t = 0; t < e.length; t++) e[t].hasAttribute("value") && e[t].parentElement.classList.add("is-filled"), e[t].addEventListener("focus", function (e) {
    ...
    for (var a = document.querySelectorAll(".btn"), t = 0; t < a.length; t++) a[t].addEventListener("click", function (e) {
        var t = e.target,
            a = t.querySelector(".ripple");
        (a = document.createElement("span")).classList.add("ripple"), a.style.width = a.style.height = Math.max(t.offsetWidth, t.offsetHeight) + "px", t.appendChild(a), a.style.left = e.offsetX - a.offsetWidth / 2 + "px", a.style.top = e.offsetY - a.offsetHeight / 2 + "px", a.classList.add("ripple"), setTimeout(function () {
...
function showError(e, t) {
    e = e.parentElement;
    e.className = "input-group input-group-outline my-5 is-invalid is-filled", e.querySelector("small").innerText = t
}
...
form.addEventListener("submit", function (e) {
    e.preventDefault(), checkRequired([username, email, password, password2]), checkLength(username, 3, 15), checkLength(password, 6, 25), checkEmail(email), checkPasswordMatch(password, password2)
});
var material = {
...
function saveLocalConfig(key, value) {
    ...
    $.ajax({
        type: 'get',
        url: '/pengaturan/local_view/' + key + '/' + value,
