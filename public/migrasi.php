...
session_start();
$koneksi = mysqli_connect('cpanel.sidbm.net', 'dbm', 'Indones1a79!', 'information_schema');
$trigger = mysqli_connect('cpanel.sidbm.net', 'dbm', 'Indones1a79!', 'dbm_laravel');
...
if (isset($_POST['copy'])) {
    ...
    mysqli_query($koneksi, "ALTER TABLE dbm_laravel.rekening_$lokasi ADD `tgl_nonaktif` DATE NULL DEFAULT NULL AFTER `jenis_mutasi`");
    ...
    mysqli_query($koneksi, "ALTER TABLE dbm_laravel.pinjaman_kelompok_$lokasi ADD `struktur_kelompok` TEXT NULL AFTER `catatan_verifikasi`");
    ...
    mysqli_query($koneksi, "UPDATE dbm_laravel.inventaris_$lokasi SET jenis='1', kategori='1' WHERE kategori='1' AND jenis='3'");
    mysqli_query($koneksi, "UPDATE dbm_laravel.inventaris_$lokasi SET jenis='3', kategori='1' WHERE kategori='5' AND jenis='2'");
    ...
    mysqli_query($koneksi, "UPDATE dbm_laravel.anggota_$lokasi AS a JOIN dbm_laravel.usaha AS u ON a.usaha = u.id SET a.usaha = u.nama_usaha WHERE a.usaha REGEXP '^-?[0-9]+(\.[0-9]+)?$'");
